...
<CardGroup cols={2}>
  ...
  <Card icon="key" title="Hashlock contract" href="/contracts/hashlock">
    Add hash conditions for HTLCs
  </Card>
  <Card icon="route" title="Spilman channel" href="/contracts/spilman-channel">
