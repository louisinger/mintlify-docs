...
description: "Integrate Lightning Network with Arkade using Submarine Swaps"
icon: "bolt"
---
...
```bash
npm install @arkade-os/ts-sdk @arkade-os/boltz-swap
```
...
```typescript
import { Wallet } from '@arkade-os/wallet-sdk';
...
<PreviousButton url="/contracts/introduction" text="Introduction" />
