...
<Accordion title="Offchain Channel State Updates and Signatures">
  This snippet simulates offchain channel updates between Alice and Bob.
Alice first sends 1000 sats, both sign the transaction, then she updates the state by sending 500 more sats, resulting in a new co-signed offchain transaction reflecting the updated balance.
