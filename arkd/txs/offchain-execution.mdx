...
Such offchain transactions are processed in the [virtual mempool](/learn/pillars/virtual-mempool) and receive [preconfirmation status](/learn/security/transaction-finality#preconfirmation) through the Arkade operator cosigning the VTXO transfer.
...
<div style={{ display: "flex", justifyContent: "center" }}>
  <img 
    ...
    src="/images/ark/sequenceoffchainlight.png" 
    alt="Sequence Diagram Offchain Transaction"
