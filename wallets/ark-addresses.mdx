...
<Frame caption="Ark Address Components">
  <div className="flex flex-col space-y-2">
    <div className="flex items-center p-2 border rounded">
      <div className="font-bold w-24">Prefix</div>
      <div className="flex-1">Network identifier: <code>ark</code> (mainnet) or <code>tark</code> (testnet)</div>
    </div>
    <div className="flex items-center p-2 border rounded">
      <div className="font-bold w-24">P2TR Key</div>
      <div className="flex-1">Taproot output key containing collaborative and exit script paths</div>
    </div>
    <div className="flex items-center p-2 border rounded">
      <div className="font-bold w-24">Server Key</div>
      <div className="flex-1">Ark Service Provider's x-only public key (32 bytes)</div>
    </div>
  </div>
</Frame>
...
<Warning>
The key path in the P2TR script is always the unspendable key <code>0250929b74c1a04954b78b4b6035e97a5e078a5a0f28ec96d547bfee9ace803ac0</code>. This ensures that all spends must reveal the script path.
</Warning>
