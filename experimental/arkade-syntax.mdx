...
- [Arkade Types](/experimental/arkade-types): Detailed information on data types
- [Arkade Functions](/experimental/arkade-functions): Reference for built-in functions

---

<NextButton url="/experimental/arkade-types" text="Arkade Types" />
