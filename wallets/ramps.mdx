...
Unilateral exit is the process of exiting a VTXO to an onchain address without the Operator's involvement. This is a more complex and expensivie process and should only be done if the Operator is not available.
