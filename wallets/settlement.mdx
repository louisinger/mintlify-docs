...
When a VTXO is first created through an offchain transaction, it exists in the pending state where it can be used for further offchain activity but carries trust assumptions about the Operator.
