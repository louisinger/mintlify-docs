...
- **OP_SCIPTNUMTOLE64** (`OP_SUCCESS224`): Converts a `CScriptNum` to an 8-byte little-endian value
- **OP_LE64TOSCIPTNUM** (`OP_SUCCESS225`): Converts an 8-byte little-endian value to a `CScriptNum`
