...
<CardGroup cols={2}>
  <Card title="LocalStorage" icon="browser" href="/storage-adapters#browser%3A-localstorage">
    Browser/PWA persistent storage using localStorage API
  </Card>
  <Card title="IndexedDB" icon="database" href="/storage-adapters#browser%3A-indexeddb">
    Browser/PWA/Service Worker advanced storage with [IndexedDB](/storage-adapters#browser%3A-indexeddb)
  </Card>
  <Card title="AsyncStorage" icon="mobile" href="/storage-adapters#react-native%3A-asyncstorage">
    React Native persistent storage
  </Card>
  <Card title="FileSystem" icon="folder" href="/storage-adapters#node-js%3A-filesystem">
