...
For more information on how to use these types with functions, see the [Arkade Functions](/experimental/arkade-functions) page.

---

<NextButton url="/experimental/arkade-functions" text="Arkade Functions" />
