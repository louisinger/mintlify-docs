...
An Arkade Note is a [recoverable VTXO](/learn/ark/vtxo-lifecycle) and is **akin to a virtual voucher** created by the server and redeemable for VTXOs.

Arkade Notes are designed for several purposess: 
