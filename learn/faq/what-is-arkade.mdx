...
It enables a multitude of fast, self-custodial financial applications on Bitcoin, including [escrows](/contracts/escrow), [synthetic assets](/experimental/synthetic-assets), or even [prediction markets](/experimental/prediction-market), without requiring consensus changes to the Bitcoin protocol.
