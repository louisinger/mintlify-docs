...
<AccordionGroup>
  ...
  <Accordion title="Transaction History">
    ...
    - [`GetVtxoChain`](https://github.com/arkade-os/arkd/blob/4cabf95f33b0196c47518425e92efc089636aa20/api-spec/protobuf/ark/v1/indexer.proto#L61-L68) traces the lineage of [Arkade transactions](/learn/pillars/arkade-tx) from any VTXO leaf spending through to the creation of a specified VTXO outpoint (ie. [tx chain](/learn/pillars/arkade-tx#transactionchains)), enabling full transaction history reconstruction
  </Accordion>
