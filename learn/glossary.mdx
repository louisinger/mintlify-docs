...
**ArkadeOS**
The operating system layer of Arkade that provides a complete execution environment for Bitcoin-native applications, including the Virtual Mempool, scripting capabilities, and coordination infrastructure.

**Arkade Batcher**
A dedicated entity responsible for collecting transaction intents and constructing batches with policy-driven properties. Operates within a TEE separately from the Arkade Operator to ensure trustworthy batch construction and transaction ordering.
